...
public class KoKomaTest {
	...
	public static void keTest() {
		String strToExtrtKwrd = "저는 대학생이구요. apple 소프트웨어 관련학과 입니다. DB는 수업을 한번 들은 적이 있으며, 수학은 대학에서 통계학, 선형대수학, 이산수학, 대학수학 등을 배웠지만... 자주 사용을 안하다보니 모두 까먹은 상태입니다.";
