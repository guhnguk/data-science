...
/**
 * This class is used for calculating similarity between two vectors, finding the closest vector within a library of
 * vectors and such, it can be used for any distance metric calculations
 * 
 * @author Barkin Aygun
 *
 */
public class Similarity {
	...
	/**
	 * Finds the most similar vector to the given index vector in the vectors using the given distance metric, returns
	 * the indexes of vectors in descending order, closest first
	 * 
	 * @param vectors
